...
var centerMenu = [
    ...
    ,{
        name: '餐饮收藏',
        url: '../canyinCollection/list.html'
    }
    ,{
        name: '餐饮订单',
        url: '../canyinOrder/list.html'
    }
    ,{
        name: '民宿收藏',
    ...
    ,{
        name: '特产收藏',
        url: '../techanCollection/list.html'
    }
    ,{
        name: '特产订单',
        url: '../techanOrder/list.html'
    }
...
var adminurl =  "http://localhost:8080/minsuyudingguanlixitong/admin/dist/index.html#/login";
